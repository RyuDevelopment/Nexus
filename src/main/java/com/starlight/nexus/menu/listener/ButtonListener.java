package com.starlight.nexus.menu.listener;
    ...
    public void onButtonPress(InventoryClickEvent event) {
        ...
        if (openMenu != null) {
            ...
            if (openMenu.getButtons().containsKey(event.getSlot())) {
                ...
                player.setMetadata("CLICKED_BUTTON",new FixedMetadataValue(Nexus.instance,player.getUniqueId().toString()));
                ...
                if (event.isCancelled()) {
                    Nexus.instance.getServer().getScheduler().runTaskLater(Nexus.instance, player::updateInventory, 1L);
                }

                player.removeMetadata("CLICKED_BUTTON", Nexus.instance);
