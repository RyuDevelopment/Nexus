...
enum class EnchantmentWrapper constructor(val friendlyName: String, parse: Array<String>) {
    ...
    PROTECTION_PROJECTILE(
        ...
        arrayOf<String>("pp", "projprot", "projprotection", "projp", "pprot")
    ),
    ...
    DAMAGE_ARTHROPODS(
        "Bane of Arthropods",
        arrayOf<String>("bane", "ardmg", "baneofarthropod", "arthropod", "dar", "dspider")
    ),
    ...
    DEPTH_STRIDER("Depth Strider", arrayOf<String>("waterwalk", "ds", "depth", "strider")),
